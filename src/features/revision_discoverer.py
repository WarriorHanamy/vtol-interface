...
class RevisionDiscoverer:
    ...
    @staticmethod
    def discover_latest(artifacts_root: Path | str, task: str) -> Optional[Path]:
        """
    ...
    @staticmethod
    def _parse_revision_name(revision_dir_name: str) -> Optional[datetime]:
        """
        ...
        try:
            ...
            if (
                len(timestamp_str) != 16
                or timestamp_str[8] != "T"
                or timestamp_str[-1] != "Z"
            ):
                return None
